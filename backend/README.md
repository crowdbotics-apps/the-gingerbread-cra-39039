...
## Project Structure
    ...
    ├── the_gingerbread_cra_39039  # Django project configurations
...
1. Clone this repo and `cd the_gingerbread_cra_39039`
...
2. Clone this repo and `cd the_gingerbread_cra_39039`
